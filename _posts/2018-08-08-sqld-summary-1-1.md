...
* 엔터티, 인스턴스, 속성, 속성값의 관계
    * 한 개의 엔터티는 두 개 이상의 인스턴스의 집압이어야 한다
...
* 기타 분류방법
    ...
    * 단일값(값이 한 개) / 다중값(집전화, 휴대전화, 회사 전화번호 / 1차 정규화 또는 별도 엔티티 생성)
...
* 관계의 정의
    ...
    * 존재의 형태로서나 행위로서의 서로에게 연관서잉 부여된 상태
* 관계의 페어링
...
* 관계차수
    ...
    * 1:1 관계: 실선
    * 1:M 관계: M 쪽에 까마귀발
    * M:M 관계: 양쪽 까마귀발, 관계엔티티를 이용하여 3개의 엔티티로 구분
* 관계선택사양
...
* 식별자관계와 비식별자관계 모델링
    ...
    * 식별자와 비식별자관계 비교
        ...
        | 표기법             | 실선 표현                                                                                                                  | 점선 표현                                                                                                                                                                                 |
        | 연결 고려사항      | -반드시 부모엔터티 종속<br>-자식 주식별자 구성에 부모 주식별자 포함 필요<br>-상속받은 주식별자속성을 타 엔터티에 이전 필요 | -약한 종속관계<br>-자식 주식별자구성을 독립적으로 구성<br>-자식 주식별자구성에 부모 주식별자 부분 필요<br>-상속받은 주식별자송성을 타 엔터티에 차단 필요<br>-부모쪽의 관계참여가 선택관계 |
